...
const EXPECTED_LEVEL_ONE_RESOURCES = {
  cash: 33480002,
  arms: 11016001,
  cargo: 11664001,
  metal: 14040001,
...
test('Freight Truck keeps incomplete calculations disabled while showing known level details', () => {
  ...
  assert.match(knownDataController, /setText\('inv_gold', 'Unknown'\)/);
  assert.match(knownDataController, /number\(level\.influenceIncrease\)/);
